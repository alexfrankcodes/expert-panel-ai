...
export function SettingsDialog({ isOpen, onClose, apiKey, provider, onSave }: SettingsDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-secondary text-neutral-100">
        ...
        <div className="space-y-4">
          ...
          <RadioGroup value={localProvider} onValueChange={setLocalProvider} className="space-y-2">
